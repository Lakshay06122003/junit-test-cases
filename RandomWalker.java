 ...
 * The Markov chain's states should be a subset of, or equal to, {"N", "E", "S",
 * "W"}.
 */
public class RandomWalker implements Walker {
     ...
     * each step. Specifically, the coordinate at index i and the coordinate at
     * index i+1
     * encode the i+1'th step from coordinate i to coordinate i+1.
     *
     * If Nsteps is 0 or negative, the resulting path is empty.
     *
     * Note that each call to walk resets the path of this walker to start again
     * from
     ...
     * 
     * @return a coordinate encoding the difference between the Walker's destination
     *         position
